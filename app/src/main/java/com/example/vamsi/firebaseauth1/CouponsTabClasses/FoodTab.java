...
public class FoodTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Brands = firebaseDatabase.getReference().child("Coupons").child(firebaseAuth.getCurrentUser().getUid()).child("Brands/Food");
    ...
    private void setCouponCount(String brand)
    {
        ...
        brandReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                String path = "Coupons/"+firebaseAuth.getCurrentUser().getUid()+"/"+"Brands/Food";
