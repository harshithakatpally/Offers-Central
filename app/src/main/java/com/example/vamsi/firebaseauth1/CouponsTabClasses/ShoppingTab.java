...
public class ShoppingTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Brands = firebaseDatabase.getReference().child("Coupons").child(firebaseAuth.getCurrentUser().getUid()).child("Brands/Shopping");
    ...
    private void setCouponCount(String brand)
    {
        ...
        brandReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                String path = "Coupons/"+firebaseAuth.getCurrentUser().getUid()+"/"+"Brands/Shopping";
